...
export default function IssueComments({ issue, currentUser, onUpdate }) {
    ...
    const getRoleBadge = (role) => {
        const badges = {
            ...
            'DEPARTMENT_MANAGER': { label: 'Manager', color: 'bg-teal-500/20 text-teal-400 border-teal-500/30' },
            'municipal': { label: 'Manager', color: 'bg-teal-500/20 text-teal-400 border-teal-500/30' },
