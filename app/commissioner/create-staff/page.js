...
export default function CommissionerCreateStaffPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success(`${formData.role === 'FIELD_OFFICER' ? 'Field Officer' : 'Department Manager'} account created successfully`);
        ...
        <DashboardLayout>
            <div className="max-w-3xl mx-auto space-y-8 animate-fade-in">
                <PageHeader
                    ...
                    subtitle="Create Department Manager or Field Officer accounts"
                />
