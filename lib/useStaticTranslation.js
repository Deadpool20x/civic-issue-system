const TRANSLATIONS = {
  ...
  'citizen.all': 'All Issues',
  'citizen.assigned': 'Assigned',
  'citizen.rejected': 'Rejected',

  // ── Categories & Subcategories ────────────────────────────
  'report.categories.roads-infrastructure.label': 'Roads & Infrastructure',
  'report.categories.roads-infrastructure.subcategories.Pothole': 'Pothole',
  'report.categories.roads-infrastructure.subcategories.Road Crack': 'Road Crack',
  'report.categories.roads-infrastructure.subcategories.Road Flooding': 'Road Flooding',
  'report.categories.roads-infrastructure.subcategories.Bridge Damage': 'Bridge Damage',
  'report.categories.roads-infrastructure.subcategories.Footpath Damage': 'Footpath Damage',

  'report.categories.street-lighting.label': 'Street Lighting',
  'report.categories.street-lighting.subcategories.Broken Streetlight': 'Broken Streetlight',
  'report.categories.street-lighting.subcategories.Flickering Light': 'Flickering Light',
  'report.categories.street-lighting.subcategories.No Light in Area': 'No Light in Area',
  'report.categories.street-lighting.subcategories.Damaged Pole': 'Damaged Pole',

  'report.categories.waste-management.label': 'Waste Management',
  'report.categories.waste-management.subcategories.Overflowing Bin': 'Overflowing Bin',
  'report.categories.waste-management.subcategories.Garbage Not Collected': 'Garbage Not Collected',
  'report.categories.waste-management.subcategories.Illegal Dumping': 'Illegal Dumping',
  'report.categories.waste-management.subcategories.Drain Blockage': 'Drain Blockage',

  'report.categories.water-drainage.label': 'Water & Drainage',
  'report.categories.water-drainage.subcategories.Water Leakage': 'Water Leakage',
  'report.categories.water-drainage.subcategories.No Water Supply': 'No Water Supply',
  'report.categories.water-drainage.subcategories.Flooded Drain': 'Flooded Drain',
  'report.categories.water-drainage.subcategories.Sewage Overflow': 'Sewage Overflow',

  'report.categories.parks-public-spaces.label': 'Parks & Public Spaces',
  'report.categories.parks-public-spaces.subcategories.Broken Equipment': 'Broken Equipment',
  'report.categories.parks-public-spaces.subcategories.Overgrown Grass': 'Overgrown Grass',
  'report.categories.parks-public-spaces.subcategories.Fallen Tree': 'Fallen Tree',
  'report.categories.parks-public-spaces.subcategories.Damaged Bench': 'Damaged Bench',

  'report.categories.traffic-signage.label': 'Traffic & Signage',
  'report.categories.traffic-signage.subcategories.Missing Sign': 'Missing Sign',
  'report.categories.traffic-signage.subcategories.Damaged Signal': 'Damaged Signal',
  'report.categories.traffic-signage.subcategories.Faded Road Markings': 'Faded Road Markings',
  'report.categories.traffic-signage.subcategories.Blocked Sign': 'Blocked Sign',

  'report.categories.public-health-safety.label': 'Public Health & Safety',
  'report.categories.public-health-safety.subcategories.Stray Animals': 'Stray Animals',
  'report.categories.public-health-safety.subcategories.Mosquito Breeding': 'Mosquito Breeding',
  'report.categories.public-health-safety.subcategories.Open Manhole': 'Open Manhole',
  'report.categories.public-health-safety.subcategories.Hazardous Material': 'Hazardous Material',

  'report.categories.other.label': 'Other',
  'report.categories.other.subcategories.General Complaint': 'General Complaint',
  'report.categories.other.subcategories.Noise Pollution': 'Noise Pollution',
  'report.categories.other.subcategories.Encroachment': 'Encroachment',
  'report.categories.other.subcategories.Other': 'Other',
};
